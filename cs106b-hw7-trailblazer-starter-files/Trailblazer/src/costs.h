 ...
 */
double terrainCost(const TBLoc& from, const TBLoc& to, const Grid<double>& world);
 ...
 */
double terrainHeuristic(const TBLoc& from, const TBLoc& to, const Grid<double>& world);

/*
 * A function that, given two adjacent locations in a maze, returns the cost
 * associated with moving from the first location to the second.
 */
double mazeCost(const TBLoc& from, const TBLoc& to, const Grid<double>& world);
 ...
 */
double mazeHeuristic(const TBLoc& from, const TBLoc& to, const Grid<double>& world);
 ...
 */
double zeroHeuristic(const TBLoc& from, const TBLoc& to, const Grid<double>& world);
