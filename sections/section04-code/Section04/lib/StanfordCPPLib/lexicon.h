...
public:
     ...
     * ---------------------
     * Removes the specified word to the lexicon, if it was present.
...
private:
    ...
    friend std::ostream& operator <<(std::ostream& os, const Lexicon& p);
...
//    private:
//        const Lexicon* lp;
//        typename Set<string>::iterator itr;
...
//            this->lp = lp;
//            if (endFlag) {
//                itr = lp->m_allWords.end();
//            } else {
//                itr = lp->m_allWords.begin();
//            }
//        }
